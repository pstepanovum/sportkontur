// FILE: src/components/pages/catalog/playgrounds/playgrounds-hero.tsx

export default function PlaygroundsHero() {
  return (
    <section className="w-full pt-[120px] md:pt-[200px] pb-16 md:pb-24 bg-white min-h-screen flex items-center">
      <div className="px-5 md:px-20 max-w-[1400px] mx-auto w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Безопасные и яркие детские площадки для дворов, парков и детских
            садов. Современное игровое оборудование из качественных материалов с
            гарантией 5 лет.
          </p>
        </div>
      </div>
