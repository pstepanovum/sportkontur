// FILE: src/components/pages/catalog/catalog-hero.tsx
    ...
    <section className="w-full pt-[120px] md:pt-[200px] pb-16 md:pb-24 bg-white min-h-screen flex items-center">
      <div className="px-5 md:px-20 max-w-[1400px] mx-auto w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Широкий ассортимент игрового и спортивного оборудования для дворов,
            парков, школ и детских садов. Найдите идеальное решение для вашего
            проекта.
          </p>
        </div>
      </div>
