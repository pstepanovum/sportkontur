// FILE: src/components/pages/catalog/surfaces/surfaces-hero.tsx
    ...
    <section className="w-full pt-[120px] md:pt-[200px] pb-16 md:pb-24 bg-white min-h-screen flex items-center">
      <div className="px-5 md:px-20 max-w-[1400px] mx-auto w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Безопасные травмобезопасные покрытия для детских и спортивных
            площадок. Резиновая крошка, искусственная трава, модульные покрытия
            и другие современные решения для любых объектов.
          </p>
        </div>
      </div>
    </section>
