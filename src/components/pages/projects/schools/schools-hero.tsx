// FILE: src/components/pages/projects/schools/schools-hero.tsx
    ...
    <section className="w-full pt-[120px] md:pt-[200px] pb-16 md:pb-24 bg-white min-h-screen flex items-center">
      <div className="px-5 md:px-20 max-w-[1400px] mx-auto w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Комплексное оснащение школьных территорий спортивным и игровым
            оборудованием. Создаем современные спортивные площадки, зоны отдыха
            и многофункциональные пространства для физического развития
            школьников.
          </p>
        </div>
      </div>
